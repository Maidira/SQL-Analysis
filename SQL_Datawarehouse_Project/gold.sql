...
-- CREATING CUSTOMER DIMENSION DATA

-- Checking whether we have duplicate primary key post left join
...
-- Checking gender post joining tables
SELECT DISTINCT
	ci.cst_gender,
	ca.gen,
...
-- CREATING PRODUCT DIMENSION DATA
...
LEFT JOIN
	...
	ON pn.cat_id = pc.id
WHERE 
	pn.prd_end_dt IS NULL;  -- Filtering out historical data
